...
% *************************************************************************
if length(prn_old2)>=2 && length(prn_both2)>=2
n = length(prn_temp2)-length(prn_both2);
contains = any(prn_old2(:) == prn_temp2(1));
...
if nSV_GPS == 0
a1 = 15+2*(nSV_GNSS)+1;
a2 = 15+2*(nSV_GNSS)+length(prn_temp2)-1;
else
a1 = 15+2*(nSV_GNSS)+1+length(prn_temp1)-1;
a2 = 15+2*(nSV_GNSS)+length(prn_temp1)-1+length(prn_temp2)-1;
end
Pbar(a1:a2,:) = 0;
Pbar(:,a1:a2) = 0;
Pbar(a1:a2,a1:a2) = 1E6*eye(length(prn_temp2)-1);
